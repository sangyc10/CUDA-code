...
2. 调用错误检查函数时，**ErrorCheck**函数的第一个参数是可以返回错误代码的**CUDA**运行时**API**函数，\_\_**FILE**\_\_和\_\_**LINE**\_\_是**C++**预先定义的标识符，**\_\_FILE\_\_**用于指示本行语句所在源文件的文件名，**\_\_LINE\_\_**用于指示本行语句在源文件中的位置信息。
